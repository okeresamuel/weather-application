...
function callTomorrowWeather(){
  return fetch(`https://weatherapi-com.p.rapidapi.com/forecast.json?q=Nigeria&days=3`, options)
}
callTomorrowWeather()
.then((data)=>{
 return data.json();
  ...
  let avgtemperatureResult = tomorrowResult[2][1].forecastday[1].day.avgtemp_c
  let maxtemperatureResult = tomorrowResult[2][1].forecastday[1].day.maxtemp_c
  let maxWindResult = tomorrowResult[2][1].forecastday[1].day.maxwind_kph
  let chanceOfRainResult = tomorrowResult[2][1].forecastday[1].day.daily_chance_of_rain
  let chanceOfSnowResult = tomorrowResult[2][1].forecastday[1].day.daily_chance_of_snow
...
function exe (){
  return fetch(`https://weatherapi-com.p.rapidapi.com/forecast.json?q=${inputInfo}&days=3`, options)
}
exe()
.then((data)=>{
  return data.json()
...
threeDaysforNigeria.style.display="none"
  ...
  fealslike.innerHTML= `Feels like ${celciusResult.toFixed(0)}<span class="fealsLikeDegree">o</span>`
...
function toggle(){
 ...
 let weatherConditionGeneral = document.querySelector(".weatherConditionGeneral")
 let degreePicGeneral = document.querySelector(".degreePicGeneral")
 let celciusForfirstGeneral = document.querySelector(".celciusForfirstGeneral")
 let tomorrowGen = document.querySelector(".tomorrowGen")
 let secondConditionGeneral = document.querySelector(".secondConditionGeneral")
 let degreePicGeneralSecond = document.querySelector(".degreePicGeneralSecond")
 let weatherConditionThirdDayGen = document.querySelector(".weatherConditionThirdDayGen")
 let weatherPicThirdDayGen = document.querySelector(".weatherPicThirdDayGen")
 ...
 secondConditionGeneral.innerHTML = result[2][1].forecastday[1].day.condition.text; 
 degreePicGeneralSecond.src = result[2][1].forecastday[1].day.condition.icon; 
 weatherConditionThirdDayGen.innerHTML = result[2][1].forecastday[2].day.condition.text;
 weatherPicThirdDayGen.src = result[2][1].forecastday[2].day.condition.icon;
...
//weather pic change
  if(weatherDiscription === "Clear"){
   $("body").css("backgroundImage", "url('https://images.unsplash.com/photo-1558486012-817176f84c6d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8d2VhdGhlciUyMGFwcHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60')")
  }else if(weatherDiscription === "Mist"){
   $("body").css("backgroundImage", "url('https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8bWlzdHxlbnwwfHwwfHw%3D&w=1000&q=80')")
  }else if (weatherDiscription === "Overcast"){
   $("body").css("backgroundImage", "url('https://images.unsplash.com/photo-1534088568595-a066f410bcda?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8Y2xvdWQlMjB3ZWF0aGVyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=600&q=60')")     
  }else if (weatherDiscription === "Partly cloudy"){
    $("body").css("backgroundImage", "url('https://images.unsplash.com/photo-1524555259-3e4f9092f97b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fHBhcnRseSUyMGNsb3VkeXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=700&q=60')")     
  }else if(weatherDiscription === "Sunny"){
    $("body").css("backgroundImage", "url('https://images.unsplash.com/photo-1578039039764-bdf4b7a02878?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8c3VubnklMjB3ZWF0aGVyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60')")      
  }else if(weatherDiscription === "Light rain shower"|| "Patchy rain possible" || "Patchy light rain with thunder"){
    $("body").css("backgroundImage", "url('https://images.unsplash.com/photo-1501691223387-dd0500403074?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fGxpZ2h0JTIwcmFpbiUyMHNob3dlciUyMHdlYXRoZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60')")      
  }
  })
...
//toggle tomorrow for General weather
  ...
  let chanceOfRainResult = result[2][1].forecastday[1].day.daily_chance_of_rain
  let chanceOfSnowResult = result[2][1].forecastday[1].day.daily_chance_of_snow
...
let weatherConditionTomorrow = document.querySelector(".weatherConditionTomorrow")
...
let secondDayWeatherGeneral = document.querySelector(".secondDayWeatherGeneral")
...
.then((data)=>{
  ...
  let result = Object.entries(data)
  let ThirddayWeatherCondition = result[2][1].forecastday[2].day.condition.text
